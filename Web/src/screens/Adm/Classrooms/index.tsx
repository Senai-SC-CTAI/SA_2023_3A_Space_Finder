...
{/*---RESERVA DE SALAS---*/}
          ...
          <Modal
              ...
              <TouchableOpacity style={styles.botaoConfirma} onPress={setModalReserva}>
          ...
          <View style={styles.centeredViewCancelar}>
            ...
            <View style={styles.modalViewCancelar}>
              ...
              <View style={styles.cardModalCancelar}>
                ...
                <View style={styles.infosModalCancelar}>
          ...
          <View style={styles.centeredViewAdd}>
            ...
            <View style={styles.modalViewAdd}>
              <View style={styles.modalHeaderAdd}>
                <Image source={require('../../../../assets/iconClose.png')} style={styles.modalHeaderOpacityAdd} />
                <Text style={styles.modalHeaderSalaAdd}>Criar nova sala</Text>
                <Pressable onPress={() => setOpenNovaSala(!openNovaSala)}>
                  <Image source={require('../../../../assets/iconClose.png')} style={styles.modalHeaderCloseAdd} />
                </Pressable>
              </View>
              ...
              <View style={styles.cardModalAdd}>
                <View style={styles.infosModalAdd}>
                  <Text style={styles.modalTextCinzaAdd}>Nome</Text>
                  <TextInput
                    style={styles.inputAdd}
                    onChangeText={setModalSalaNome}
                    placeholder=" "
                  />
                  <View style={styles.barraModalAdd}></View>
                  <Text style={styles.modalTextCinzaAdd}>Especificação</Text>
                  <TextInput
                    style={styles.inputAdd}
