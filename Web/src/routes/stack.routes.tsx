    ...
    return (
        <Stack.Navigator>
            ...
            <Screen
                ...
                options={{
                    title: 'Bem-vindo!', headerStyle: { backgroundColor: '#003F72', height: 160, },
            ...
            <Screen
                ...
                options={{
                    title: 'Esqueci minha senha', headerStyle: { backgroundColor: '#003F72', height: 160, },
            ...
            <Screen
                ...
                options={{
                    title: 'Nova senha!', headerStyle: { backgroundColor: '#003F72', height: 160, },
                    headerTintColor: '#fff', headerTitleStyle: { fontSize: 20 }, headerTitleAlign: 'center',
                }}
            />
            ...
            <Screen
                ...
                options={{
                    title: 'Cadastro', headerStyle: { backgroundColor: '#003F72', height: 160 },
                    headerTintColor: '#fff', headerTitleStyle: { fontSize: 25 }, headerTitleAlign: 'center',
                }}
            />
            <Screen
