...
import {styles} from '../theme/ScreenClassBookingTeacherStyle';
...
export default function ScreenClassBookingTeacher({ navigation }: { navigation: any }) {
  ...
  const startDate = getFormatedDate(today.setDate(today.getDate()+1), 'DD/MM/YYYY') //modal calendar
  ...
  function handleChange(){ //modal calendar
    setDate(propDate);
  }
