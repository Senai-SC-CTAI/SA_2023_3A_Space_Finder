        ...
        <Stack.Navigator>
          ...
          headerTintColor:'#fff', headerTitleStyle:{fontSize:25}, headerTitleAlign:'center', }}
            ...
            <Screen
                ...
                options={{ title: '1A', headerStyle:{ backgroundColor:'#003F72' }, 
          headerTintColor:'#fff', headerTitleStyle:{fontSize:25}, headerTitleAlign:'center', }}
            />
            <Screen
                name='ScreenClassBooking1B'
                component={ScreenClassBooking1B}
                options={{ title: '1B', headerStyle:{ backgroundColor:'#003F72' }, 
          headerTintColor:'#fff', headerTitleStyle:{fontSize:25}, headerTitleAlign:'center', }}
            />
            <Screen
                name='ScreenClassBooking1C'
                component={ScreenClassBooking1C}
                options={{ title: '1C', headerStyle:{ backgroundColor:'#003F72' }, 
          headerTintColor:'#fff', headerTitleStyle:{fontSize:25}, headerTitleAlign:'center', }}
            />
            <Screen
                name='ScreenClassBooking1D'
                component={ScreenClassBooking1D}
                options={{ title: '1D', headerStyle:{ backgroundColor:'#003F72' }, 
          headerTintColor:'#fff', headerTitleStyle:{fontSize:25}, headerTitleAlign:'center', }}
            />
          ...
          headerTintColor:'#fff', headerTitleStyle:{fontSize:25}, headerTitleAlign:'center', }}
            ...
            <Screen
                ...
                options={{ title: '2B', headerStyle:{ backgroundColor:'#003F72' }, 
          headerTintColor:'#fff', headerTitleStyle:{fontSize:25}, headerTitleAlign:'center', }}
            />
            <Screen
                name='ScreenClassBooking2C'
                component={ScreenClassBooking2C}
                options={{ title: '2C', headerStyle:{ backgroundColor:'#003F72' }, 
          headerTintColor:'#fff', headerTitleStyle:{fontSize:25}, headerTitleAlign:'center', }}
            />
            <Screen
                name='ScreenClassBooking2D'
                component={ScreenClassBooking2D}
                options={{ title: '2D', headerStyle:{ backgroundColor:'#003F72' }, 
          headerTintColor:'#fff', headerTitleStyle:{fontSize:25}, headerTitleAlign:'center', }}
            />
            ...
            <Screen
                ...
                options={{ title: '3A', headerStyle:{ backgroundColor:'#003F72' }, 
          headerTintColor:'#fff', headerTitleStyle:{fontSize:25}, headerTitleAlign:'center', }}
            />
            <Screen
                name='ScreenClassBooking3B'
                component={ScreenClassBooking3B}
                options={{ title: '3B', headerStyle:{ backgroundColor:'#003F72' }, 
          headerTintColor:'#fff', headerTitleStyle:{fontSize:25}, headerTitleAlign:'center', }}
            />
            <Screen
                name='ScreenClassBooking3C'
                component={ScreenClassBooking3C}
                options={{ title: '3C', headerStyle:{ backgroundColor:'#003F72' }, 
          headerTintColor:'#fff', headerTitleStyle:{fontSize:25}, headerTitleAlign:'center', }}
            />
            <Screen
                name='ScreenClassBooking3D'
                component={ScreenClassBooking3D}
                options={{ title: '3D', headerStyle:{ backgroundColor:'#003F72' }, 
          headerTintColor:'#fff', headerTitleStyle:{fontSize:25}, headerTitleAlign:'center', }}
            />
